...
void main() {
    ...
    while (1) {                             // while 문 출력함, 역할은 해당 lung에서 설명 하겠음.
        ...
        Num1 = rand() % 100 + 1;            // Num1을 1부터 100 사이의 난수로 지정함. 모든 값은 100으로 나누면 나머지가 0에서 99 사이이기 때문에 거기에 1을 더해줘서 1부터 100까지의 난수로 지정할 수 있음.
        Num2 = rand() % 100 + 1;            // Num2를 1부터 100 사이의 난수로 지정함.
